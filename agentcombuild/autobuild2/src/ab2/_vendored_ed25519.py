"""Vendored from ~/qp/acom/ed25519.py (prx0r/qp, MIT) on 2026-09-14.

Pure-Python Ed25519 (RFC 8032). Copied verbatim below the provenance note
so ab2 has zero cryptographic dependencies. Do not hand-edit the math;
to upgrade, re-vendor from qp and note the qp commit here.
"""
import hashlib
