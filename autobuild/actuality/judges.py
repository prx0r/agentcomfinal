"""Judges L0/L1 (PROMOTED to canonical 2026-09-14, gitbuild1 experiment 1).

Provenance: verbatim promotion of agentcombuild/autobuild3/src/ab3/judges.py
(frozen history — do not edit there; evolve here under a new gate id if
semantics change). Structure check + CEL-subset predicates. Pure, total,
three-valued: inadmissible evidence and eval errors yield UNKNOWN; judges
never raise.
"""
import re
