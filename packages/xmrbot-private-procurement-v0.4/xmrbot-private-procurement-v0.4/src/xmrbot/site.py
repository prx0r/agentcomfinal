...
def site_map() -> dict:
    return {
        ...
        "human_surfaces": [
            ...
            {"path": "/providers", "purpose": "private-economy provider registry and procurement router"},
        ...
        "machine_surfaces": [
            ...
            {"path": "/v1/providers", "purpose": "provider adapter registry"},
            {"uri": "xmrbot://providers", "purpose": "MCP provider registry resource"},
        ],
        "principles": [
            "No custody.",
...
- Provider registry: {base}/v1/providers
- Procurement router: {base}/v1/procurement/route
...
- Private procurement/providers: {base}/providers
...
7. For private-economy actions, use `xmr_provider_list` → `xmr_procurement_route` → `xmr_provider_propose`. Spending-capable provider actions require an exact QP grant; public MCP does not expose an unrestricted wallet.
